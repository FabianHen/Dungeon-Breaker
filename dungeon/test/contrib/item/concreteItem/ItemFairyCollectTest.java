...
class ItemFairyCollectTest {
  ...
  /**
   * Stellt sicher, dass die Fee niemals in ein Inventar aufgenommen werden kann
   * und die Methode folgerichtig immer false zurückgibt.
   */
  @Test
  ...
  /**
   * Bestätigt, dass die Methode robust programmiert ist und selbst bei der Übergabe
   * von leeren Variablen (null) nicht abstürzt, sondern sicher false liefert.
   */
  @Test
